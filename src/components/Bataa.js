...
import useBataa from "../hooks/useBataa";
const Bataa = (props) => {
  const navigation = useNavigation();
  const { id } = props.route.params;
  const [bataa, error] = useBataa(id);
  if (error) {
    return (
  ...
  return (
    ...
    >
      <ImageBackground
        source={{ uri: api + "/upload/" + bataa.p12Ba1 }}
      ...
      <View style={{ marginHorizontal: 20 }}>
        ...
        <Text style={styles.textTitle}>{bataa.p60Title}</Text>
        <Text style={styles.textStatus}>{bataa.p60Text}</Text>
        <Text style={styles.textTitle}>{bataa.p60Title1}</Text>
        <Text
          style={{
            fontSize: 16,
            fontFamily: "Montserrat-regular",
        ...
        <Text style={styles.textStatus}>{bataa.p60Text2}</Text>
        <Text style={styles.textTitle}>{bataa.p60Title2}</Text>
        <Text style={styles.textStatus}>{bataa.p60Text3}</Text>
        <Text style={styles.textTitle}>{bataa.p60Title3}</Text>
        <Text style={styles.textStatus}>{bataa.p60Text4}</Text>
        ...
        <Image
          source={{ uri: api + "/upload/" + bataa.p12Ba2 }}
          style={{ width: windowWidth / 1.1, height: 200 }}
        />
        <Text style={[styles.textTitle, { marginTop: 20 }]}>
          {bataa.p61Title}
        </Text>
        <Text style={styles.textStatus}>{bataa.p61Text}</Text>
        <Text style={styles.textTitle}>{bataa.p61Title1}</Text>
        <Text style={styles.textStatus}>{bataa.p61Text1}</Text>
        ...
        <Text style={styles.textTitle}>{bataa.p61Title2}</Text>
        <Text style={styles.textStatus}>{bataa.p61Text2}</Text>
      </View>
      <View style={{ marginHorizontal: 20 }}>
        <ImageBackground
          source={{ uri: api + "/upload/" + bataa.p12Ba3 }}
        ...
        <ScrollView horizontal>
          <Image
            source={{ uri: api + "/upload/" + bataa.p12BaTable }}
