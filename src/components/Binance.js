...
const Binance = (props) => {
  ...
  const [binance, error] = useBinance(id);
  if (error) {
    return (
  ...
  return (
    ...
    >
      ...
      <ImageBackground
        ...
        source={{ uri: api + "/upload/" + binance.p10Bg }}
      >
        <AntDesign
          name="arrowleft"
          size={30}
        ...
        >
          ...
          >
            {binance.p42Title} {binance.p42Title1}
          </Text>
        </View>
        <Image
      ...
      >
        ...
        >
          {binance.p10BiCeoWork}
        </Text>
        <Text style={styles.textStatus}>{binance.p43Text2}</Text>
      </View>
      {/* Binance zurag */}
      <ScrollView
        horizontal
      ...
      >
        <Image
          source={{ uri: api + "/upload/" + binance.p10BiTable }}
      ...
      >
        ...
        <View style={{ marginHorizontal: 20, marginTop: 50 }}>
          ...
          >
            {binance.p10BiGraphTitleYellow}
          </Text>
          <Text
            style={{ textAlign: "right", fontFamily: "Montserrat-regular" }}
          >
            {binance.p10BiGraphText}
          </Text>

          <Image
            source={{ uri: api + "/upload/" + binance.p10BiGraph }}
            resizeMode="contain"
            style={{
              width: windowWidth,
              height: 600,
      ...
      >
        <Text style={styles.binanceTitle}>{binance.p49Title}</Text>
        <View
        ...
        />
        <Text style={styles.binanceTitle}>{binance.p49Title2}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text1}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text2}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text3}</Text>
        <Text style={styles.binanceTitle}>{binance.p49Title3}</Text>
          ...
          <View style={{ flex: 0.5 }}>
            ...
            <View style={{ flexDirection: "row", flex: 1 }}>
              <View style={{ flex: 0.5 }}>
                ...
                >
                  {binance.p49OfficeCountryNumber}
                </Text>
                <Text
                  style={{
                    fontFamily: "Montserrat-regular",
        ...
        <Text style={styles.binanceStatus}>{binance.p49Text4}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text5}</Text>
        <Text style={styles.binanceStatus}>{binance.p49Text6}</Text>
        <Image
          source={{ uri: api + "/upload/" + binance.p10BiCompany }}
          style={{
            width: windowWidth / 1.1,
        ...
        />
        <Text style={styles.binanceTitle}>{binance.p10BiCompanyTitle}</Text>
        <Text style={styles.binanceStatus}>{binance.p10BiCompanyText}</Text>
        <Text style={styles.binanceStatus}>{binance.p10BiCompanyText1}</Text>
        <View style={{ flexDirection: "row", paddingBottom: 20 }}>
          <Image
            source={{ uri: api + "/upload/" + binance.p10BiFriends }}
            style={{ width: windowWidth / 2.5, height: 150, marginRight: 3 }}
          />
          <Image
            source={{ uri: api + "/upload/" + binance.p10BiTeam }}
            style={{ width: windowWidth / 2, height: 150, marginLeft: 3 }}
          />
        </View>
        <Text style={styles.binanceTitle}>{binance.p51Title}</Text>
        <Image
        ...
        >
          <View style={{ marginRight: 5 }}>
            <Text style={styles.graphText}>
              <Text style={{ color: "#f15623" }}> ♦︎</Text> {binance.p51Status}{" "}
              <Text style={styles.graphPercent}> /6.8%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#ffc20e" }}> ♦︎</Text> {binance.p51Status1}{" "}
              <Text style={styles.graphPercent}> /21.5%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#55b8ae" }}> ♦︎</Text> {binance.p51Status2}{" "}
              <Text style={styles.graphPercent}> /2.3%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#0066a6" }}> ♦︎</Text> {binance.p51Status3}{" "}
              <Text style={styles.graphPercent}> /40.7%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#00aeef" }}> ♦︎</Text> {binance.p51Status4}{" "}
              <Text style={styles.graphPercent}>/1.1%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#97daf8" }}> ♦︎</Text> {binance.p51Status5}{" "}
              <Text style={styles.graphPercent}>/7.3%/</Text>
            </Text>
          </View>
          <View style={{ marginLeft: 5 }}>
            <Text style={styles.graphText}>
              <Text style={{ color: "#7b95cc" }}> ♦︎</Text> {binance.p51Status6}{" "}
              <Text style={styles.graphPercent}> /2.9%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#746c9b" }}> ♦︎</Text> {binance.p51Status7}{" "}
              <Text style={styles.graphPercent}> /3.9%/</Text>
            </Text>
            <Text style={styles.graphText}>
              <Text style={{ color: "#784785" }}> ♦︎</Text> {binance.p51Status8}{" "}
              <Text style={styles.graphPercent}> /6.1%/</Text>
            </Text>

            <Text style={styles.graphText}>
              <Text style={{ color: "#a93b91" }}> ♦︎</Text> {binance.p51Status9}{" "}
        ...
        <Text style={styles.binanceTitle}>{binance.p51ReqTitle}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req1}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req2}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req3}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req4}</Text>
        <Text style={styles.binanceStatus}> {binance.p51Req5}</Text>
        <Text style={styles.binanceStatus}>{binance.p51Req6}</Text>
        <Text style={styles.binanceStatus}>{binance.p51ReqText}</Text>
        <Text style={styles.binanceTitle}>{binance.p51SalaryTitle} </Text>
      </View>
      {/* tsalingiin hemjee */}
      {/* 1 */}
      ...
      <View style={{ backgroundColor: "white", padding: 20 }}>
        <Text style={styles.binanceStatus}>{binance.p52Text}</Text>
        <Text style={styles.binanceStatus}>{binance.p52Text1}</Text>
        <Text style={styles.binanceStatus}>{binance.p52Text2}</Text>
